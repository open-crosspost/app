...
const CreateOptionsSchema = z.object({
  ...
  account: z.string().optional().describe("NEAR mainnet account (e.g., myname.near)"),
  ...
  includeHost: z.boolean().optional().describe("Include host package locally (default: false)"),
  includeGateway: z
    .boolean()
    .optional()
...
export const bosContract = oc.router({
  ...
  secretsList: oc.route({ method: "GET", path: "/secrets/list" }).output(SecretsListResultSchema),
  ...
  logout: oc.route({ method: "POST", path: "/logout" }).output(LogoutResultSchema),
